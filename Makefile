...
$(BUILD_DIR)/$(FS_DIR)/%.o: $(FS_DIR)/%.c
	$(shell mkdir -p $(BUILD_DIR)/$(FS_DIR))
...
FS_ASM_FILES = $(wildcard $(FS_DIR)/*.S)
...
OBJ_FILES += $(FS_C_FILES:$(FS_DIR)/%.c=$(BUILD_DIR)/$(FS_DIR)/%.o)
OBJ_FILES += $(FS_ASM_FILES:$(FS_DIR)/%.S=$(BUILD_DIR)/$(FS_DIR)/%.o)
